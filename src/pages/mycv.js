                        ...
                        <tbody>
                            {paginatedData.length > 0 ? (
                                paginatedData.map((sub) => {
                                    ...
                                    const matchedTemplate = templates.find(t => t.id === sub.template_no);
                    ...
                    <div className="flex justify-between items-center mt-4">
                        ...
                        <div className="flex space-x-2">
                            <button
                                ...
                                className={`px-4 py-2 border rounded ${currentPage === 0 ? 'bg-gray-100 cursor-not-allowed' : 'hover:bg-gray-100'}`}
                            >
                                Previous
                            </button>
                            <button
                                ...
                                className={`px-4 py-2 border rounded ${(currentPage + 1) * itemsPerPage >= filteredData.length ? 'bg-gray-100 cursor-not-allowed' : 'hover:bg-gray-100'}`}
                            >
                                Next
                            </button>
                        </div>
