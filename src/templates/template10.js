  ...
  <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 mt-8">
    ...
    <div className="sm:col-span-7 space-y-8">
      ...
      {candidate?.proficiency?.length > 0 ? (
        <div className="mt-6">
          <h1 className="font-bold text-lg mb-1" style={{ color: 'rgb(46, 88, 166)' }}>PROFICIENCY QUALIFICATION</h1>
          <div className="h-[2px] bg-gray-200 mb-3"></div>
          <div className="space-y-4">
      ...
      {candidate?.training?.length > 0 ? (
        <div className="mt-6">
          <h1 className="font-bold text-lg mb-1" style={{ color: 'rgb(46, 88, 166)' }}>TRAININGS & WORKSHOPS</h1>
          <div className="h-[2px] bg-gray-200 mb-3"></div>
          <div className="space-y-4">
    ...
    <div className="sm:col-span-5 space-y-8">
      ...
      {candidate.referees?.length > 0 ? (
        <div className="mt-6">
          <h1 className="font-bold text-lg mb-1" style={{ color: "rgb(46, 88, 166)" }}>REFEREES</h1>
          <div className="h-[2px] bg-gray-200 mb-3"></div>
          <div className="space-y-4">
