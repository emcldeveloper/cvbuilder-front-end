        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
                      ...
                      <div key={index} className="flex">
                        ...
                        <div className="w-8/12">
                          <div>
                            <div>
                              <p>
                                <span className="font-bold">{item.employer?.employer_name || 'Unknown Employer'}</span>
                              </p>
                            </div>
                          </div>
                              ...
                              item.positions.map((positionItem, positionIndex) => (
                                <div key={positionIndex} className="flex space-x-2">
                                  ...
                                  <div className="py-0 my-0">
                                    ...
                                    <i>{positionItem.employer?.employer_name || 'Unknown Employer'}</i>
                                    <p>
          ...
          <div className="mt-8">
           ...
           <div className="mt-8">
            ...
            <div className="grid grid-cols-12 mt-2">
              <div className="col-span-4 pr-8">
                <h1 className="font-bold text-lg">REFERENCIES</h1>
              </div>
              <div className="col-span-8">
