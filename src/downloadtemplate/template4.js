          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
            ...
            <div className="absolute text-gray-200 opacity-10 text-6xl font-bold">
              ...
              <div className="flex flex-col items-center justify-center">
               <h1 className="text-4xl font-bold" style={{ color: "rgb(46, 88, 166)" }}>{candidate.applicant_profile[0]?.first_name},{candidate.applicant_profile[0]?.last_name}</h1>
              ...
              <div className="mt-6">
              <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>PROFESSIONAL SUMMARY</h1>
               <div className="h-[2px] bg-gray-100 mb-2 "></div>
               <p >
                {candidate.careers[0].career!==null ? candidate.careers[0].career:"Not Specified"}
               </p>
               <h1 className="font-bold mt-2" style={{ color: "rgb(46, 88, 166)" }}>
               Career Objective
               </h1>
               <p>
              ...
              <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>WORKING EXPRIENCE</h1>
              <div className="h-[2px] bg-gray-100 mb-2 "></div>
             ...
             experiences.map((item)=>{
                return <div className="">
                  <div className="flex"></div>
                          <div className="">
                            <div className=" ">
                            <p> <span className="font-bold"  style={{ color: "rgb(46, 88, 166)" }}>{item.employer.employer_name} </span></p>
                        ...
                        <ul className="list-disc list-outside  ml-5 space-y-2">
                            {item.positions.map((item)=>{
                                ...
                                <div>
                                <p className="font-bold" style={{ color: "rgb(211, 99, 20)" }}>{item.position?.position_name}</p>
              ...
              <div className="mt-6">
              <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>LANGAUGES</h1>
               <div className="h-[2px] bg-gray-100 mb-2 "></div>
              ...
              <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>SKILLS</h1>
               ...
               <p className="flex space-x-1"><span className="font-bold" style={{ color: "rgb(211, 99, 20)" }}>Tools:</span>
              ...
              <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>EDUCATION DETAILS</h1>
               <div className="h-[2px] bg-gray-100 mb-2 "></div>
               {candidate.education.map((item)=>{
                return <p><div>
                <p> <span className="font-bold" style={{ color: "rgb(211, 99, 20)" }}>{item?.course.course_name}:</span> {new Date(item?.started).getFullYear()} - {new Date(item?.ended).getFullYear()}</p>
              ...
              }
              {
                ...
                <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>PROFICIENCY QUALIFICATION</h1>
                 <div className="h-[2px] bg-gray-100 mb-2 "></div>
                 {candidate.proficiency.map((item)=>{
                 return <>
                  <p> <span className="font-bold" style={{ color: "rgb(211, 99, 20)" }}>{item?.award}:</span> {formatDate (item?.started)} - { formatDate (item?.ended)}</p>
              ...
              
              {
                ...
                <h1 className="font-bold mt-5 mb-1 text-lg"  style={{ color: "rgb(46, 88, 166)" }}>REFEREES</h1>
                 <div className="h-[2px] bg-gray-100 mb-2 "></div>
                 <div className="space-y-3">
                 {candidate.referees.map((item)=>{
                  return <p><div>
                  <p style={{ color: "rgb(211, 99, 20)" }}> <span className="font-bold">{item?.first_name} {item?.middle_name} {item?.last_name}</span></p>
                  <p>{item.referee_position}</p>
                  <p> <span className="font-bold" style={{ color: "rgb(211, 99, 20)" }}>Phone:</span> {item?.phone}</p>
                  <p> <span className="font-bold" style={{ color: "rgb(211, 99, 20)" }}>Email:</span> {item?.email}</p>
                </div>
                </p>
                 })}
                 </div>
