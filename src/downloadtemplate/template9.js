              ...
              <div>
                ...
                {candidate.referees.map((item, index) => (
                  <div key={index} className="mb-4">
                    ...
                    <h1 className="text-2X1 font-bold mt-3">    {item?.first_name} {item?.middle_name} {item?.last_name}</h1>
      ...
      <div className="space-y-4">
        {experiences.map((experience) => (
          <div className="flex flex-col mb-4" key={experience.id}>
            ...
            <div>
              <p>
                <span className="font-bold">{experience.employer?.employer_name || "Employer not specified"}</span>
              </p>
            </div>
      ...
      {candidate.referees?.length > 0 ? (
        candidate.referees.map((referee, index) => (
          <div key={referee.id || index} className="mb-4">
            ...
            {/* Referee Position */}
            {referee.referee_position && <p>{referee.referee_position}</p>}
