...
const ApplicantSkillsSection = ({ applicant, isApplicant }) => {
    ...
    const uniqueKnowledges = [...new Set(applicant?.knowledge?.map(item => item.knowledge?.knowledge_name))].filter(Boolean);
    const uniqueSoftwares = [...new Set(applicant?.software?.map(item => item.software?.software_name))].filter(Boolean);
    const uniqueTools = [...new Set(applicant?.tools?.map(item => item.tool?.tool_name))].filter(Boolean);
                                ...
                                <Form.Group as={Row} className="mb-3">
                                    ...
                                    <Col sm={9}>
                                        <Form.Select
                                            ...
                                            onChange={(e) => handleChange('cultures', Array.from(e.target.selectedOptions, option => option.value))}
                                        >
                                ...
                                <Form.Group as={Row} className="mb-3">
                                    ...
                                    <Col sm={9}>
                                        <Form.Select
                                            ...
                                            onChange={(e) => handleChange('personalities', Array.from(e.target.selectedOptions, option => option.value))}
                                        >
                                ...
                                <Form.Group as={Row} className="mb-3">
                                    ...
                                    <Col sm={9}>
                                        <Form.Select
                                            ...
                                            onChange={(e) => handleChange('knowledges', Array.from(e.target.selectedOptions, option => option.value))}
                                        >
                                ...
                                <Form.Group as={Row} className="mb-3">
                                    ...
                                    <Col sm={9}>
                                        <Form.Select
                                            ...
                                            onChange={(e) => handleChange('softwares', Array.from(e.target.selectedOptions, option => option.value))}
                                        >
                                ...
                                <Form.Group as={Row} className="mb-3">
                                    ...
                                    <Col sm={9}>
                                        <Form.Select
                                            ...
                                            onChange={(e) => handleChange('tools', Array.from(e.target.selectedOptions, option => option.value))}
                                        >
