            ...
            <form onSubmit={handleSubmit} style={styles.form}>
                ...
                <div style={styles.formColumns}>
                    ...
                    <div style={styles.column}>
                        ...
                        <div style={styles.formGroup}>
                            <label htmlFor="middleName" style={styles.label}>Middle Name</label>
                            <input
                                type="text"
                                id="middleName"
                                name="middleName"
                        ...
                        <div style={styles.formGroup}>
                            <label htmlFor="maritalStatus" style={styles.label}>Marital Status</label>
                            <select
                                id="maritalStatus"
                                name="maritalStatus"
                    ...
                    <div style={styles.column}>
                        ...
                        <div style={styles.formGroup}>
                            <label htmlFor="subLocation" style={styles.label}>Sub Location</label>
                            <input
                                type="text"
                                id="subLocation"
                                name="subLocation"
