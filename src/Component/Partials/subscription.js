...
const SubscriptionSection = ({ isLoggedIn }) => {
    ...
    const handlePaymentSubmit = () => {
            ...
            Swal.fire({
                            title: "Success!",
                            text: " payment for subscription is successful",
                            icon: "success",
                        });
        setPaymentCode("");
            ...
            <Modal show={showInvoice} onHide={handleInvoiceClose} centered>
                ...
                <Table bordered hover responsive className="mt-3">
                    ...
                    >
                        ...
                        <a
                            href={`https://wa.me/255677975251?text=Hello%20Ekazi%2C%20I%20have%20paid%20for%20the%20Premium%20Plan.%20My%20payment%20code%20is%3A%20${encodeURIComponent(
                                paymentCode
                            )}`}
                            target="_blank"
