              ...
              <Card.Body>
                <Row className="align-items-center">
                  ...
                  <Col xs={12} md={2} className="text-center mb-3 mb-md-0">
                    <Image
                      src={job.client?.logo ? `https://ekazi.co.tz/${job.client.logo}` : defaultLogo}
                      alt="Employer Logo"
                      roundedCircle
                      width={70}
                      height={70}
                  ...
                  <Col xs={12} md={8}>
                   ...
                   {job.job_position?.position_name || "Untitled Position"}
                    ...
                    <div className="text-muted small">
                      <strong>Level:</strong> {job.position_level?.position_name || "Not specified"} •{" "}
                      <strong>Deadline:</strong> {job.dead_line ? formatDate(job.dead_line) : "N/A"}
                    </div>
                  </Col>
